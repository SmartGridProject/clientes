...
Para envio de datos la normalizacion de la trama:

"{E:{I1:0,I2:1},S:{Q1:0,Q2:1},IA:{IA1:444,IA2:0.00}}&"

Nota: caracter de finalizacion de trama '&'
...
You're reading the README for the master branch of serialport. You probably want to be looking at the README of our latest release. See our [change log](changelog.md) for what's new.

 - [`serialport@4.0.0-beta3` docs are here](https://github.com/EmergingTechnologyAdvisors/node-serialport/blob/4.0.0-beta3/README.md) it is the latest `4.x` releases.
